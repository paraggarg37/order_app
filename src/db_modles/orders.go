...
type Order struct {
	...
	OriginLat      string    `boil:"origin_lat" json:"origin_lat" toml:"origin_lat" yaml:"origin_lat"`
	OriginLNG      string    `boil:"origin_lng" json:"origin_lng" toml:"origin_lng" yaml:"origin_lng"`
	DestinationLat string    `boil:"destination_lat" json:"destination_lat" toml:"destination_lat" yaml:"destination_lat"`
	DestinationLNG string    `boil:"destination_lng" json:"destination_lng" toml:"destination_lng" yaml:"destination_lng"`
...
var OrderWhere = struct {
	ID             whereHelperint64
	OriginLat      whereHelperstring
	OriginLNG      whereHelperstring
	DestinationLat whereHelperstring
	DestinationLNG whereHelperstring
	...
	OriginLat:      whereHelperstring{field: `origin_lat`},
	OriginLNG:      whereHelperstring{field: `origin_lng`},
	DestinationLat: whereHelperstring{field: `destination_lat`},
	DestinationLNG: whereHelperstring{field: `destination_lng`},
	Distance:       whereHelperint{field: `distance`},
...
var (
	orderColumns               = []string{"id", "origin_lat", "origin_lng", "destination_lat", "destination_lng", "distance", "status", "created_at", "updated_at"}
	orderColumnsWithoutDefault = []string{"origin_lat", "origin_lng", "destination_lat", "destination_lng", "distance"}
...
func (q orderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_modles: failed to execute a one query for orders")
	}
...
func (q orderQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db_modles: failed to assign all query results to Order slice")
	}
...
func (q orderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: failed to count orders rows")
	}
...
func (q orderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db_modles: failed to check if orders exists")
	}
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db_modles: unable to select from orders")
	}
...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db_modles: no orders provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db_modles: unable to insert into orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db_modles: unable to populate default values for orders")
	}
...
func (o *Order) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db_modles: unable to update orders, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to update orders row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: failed to get rows affected by update for orders")
	}
...
func (q orderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to update all for orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to retrieve rows affected for orders")
	}
...
func (o OrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("db_modles: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to update all in order slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to retrieve rows affected all in update all order")
	}
	return rowsAff, nil
}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db_modles: no orders provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("db_modles: unable to upsert orders, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "db_modles: unable to upsert for orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db_modles: unable to retrieve unique values for orders")
	}
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db_modles: no Order provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to delete from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: failed to get rows affected by delete for orders")
	}
...
func (q orderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db_modles: no orderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to delete all from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: failed to get rows affected by deleteall for orders")
	}
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db_modles: no Order slice provided for delete all")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db_modles: unable to delete all from order slice")
	}
...
func (o *OrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db_modles: unable to reload all in OrderSlice")
	}
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db_modles: unable to check if orders exists")
	}
